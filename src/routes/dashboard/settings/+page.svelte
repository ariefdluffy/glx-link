				...
				<div>
					...
					{#if !data.user.emailVerified}
						...
						{#if verificationMessage}
							<div class="mt-2 flex items-center gap-2 rounded-lg bg-emerald-500/10 px-3 py-2">
								<svg
									xmlns="http://www.w3.org/2000/svg"
								...
								<span class="text-xs text-emerald-400">{verificationMessage}</span>
							</div>
						{/if}

						{#if verificationError}
							<div class="mt-2 flex items-center gap-2 rounded-lg bg-red-500/10 px-3 py-2">
								<svg
									xmlns="http://www.w3.org/2000/svg"
								...
								<span class="text-xs text-red-400">{verificationError}</span>
							</div>
						{/if}
					{:else}
