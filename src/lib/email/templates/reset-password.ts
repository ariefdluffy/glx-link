        ...
        <table width="480" cellpadding="0" cellspacing="0" style="background:rgba(24,24,31,0.7);border:1px solid rgba(255,255,255,0.08);border-radius:24px;backdrop-filter:blur(14px);padding:40px 32px;">
          ...
          <tr>
            <td align="center" style="padding-bottom:8px;">
              <h1 style="font-family:'Plus Jakarta Sans',sans-serif;font-size:22px;font-weight:600;color:#f4f4f5;margin:0;">Reset Password</h1>
            </td>
          </tr>
          <!-- Subtitle -->
          <tr>
          ...
          <tr>
            <td align="center" style="padding-bottom:24px;">
              <a href="${resetUrl}" target="_blank" style="display:inline-block;background:#ffffff;color:#000000;font-size:14px;font-weight:600;padding:14px 36px;border-radius:16px;text-decoration:none;font-family:'Inter',sans-serif;">
                Reset Password
              </a>
            </td>
          </tr>
          ...
          <tr>
            <td align="center" style="padding-bottom:24px;">
              <p style="font-size:12px;color:#8b8b94;margin:0;line-height:1.6;">
                ...
                <span style="color:#7c3aed;font-size:11px;word-break:break-all;">${resetUrl}</span>
              </p>
            </td>
          </tr>
          <!-- Divider -->
          ...
          <tr>
            <td align="center" style="padding-top:16px;">
              <p style="font-size:11px;color:#5a5a62;margin:0;line-height:1.5;">
                Link reset berlaku selama 1 jam.<br/>
                Jika kamu tidak meminta reset password, abaikan email ini.<br/>
